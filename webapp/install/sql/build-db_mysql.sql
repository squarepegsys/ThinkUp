...
-- Auto-generated by thinkup/extras/scripts/migratedb script on 2011-09-18
--
...
CREATE TABLE tu_posts (
  id int(11) NOT NULL AUTO_INCREMENT COMMENT 'Internal unique ID..',
  post_id varchar(30) NOT NULL COMMENT 'The ID of the post inside the respective service.',
  ...
  in_reply_to_post_id varchar(30) DEFAULT NULL COMMENT 'The ID of the post that this post is in reply to.',
  ...
  in_retweet_of_post_id varchar(30) DEFAULT NULL COMMENT 'The ID of the post that this post is a retweet of. [Twitter-specific]',
...
-- Dump completed on 2011-09-18  0:11:29
